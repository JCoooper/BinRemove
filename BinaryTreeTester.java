...
public class BinaryTreeTester {
	...
	public static void main(String[] args) {
		...
		System.out.println("Matches " + tree.countMatches(20));
		System.out.println("Max R " + tree.maxRecord());
		System.out.println("Min R " + tree.minRecord());
		int Rkey = 1000;
		tree.removeNode(Rkey);
		System.out.println("Removing The Number " + Rkey + ".");
